# In this version silences are extracted together with other informations
...
silences = To TextGrid (silences): silence_threshold_db, minimum_silent_interval_duration, minimum_sounding_interval_duration, "silent", "sounding"
...
removeObject: audio, pitch, pitch_tier, pitch_tier_tor, pitch_tier_table, point_process, intensity, intensity_tier, intensity_tier_tor, intensity_tier_table, param_table, voice_report_table, silences, silences_table
